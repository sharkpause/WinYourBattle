<x-layout>
      <div class="container"><div class="d-flex flex-column min-vh-80 justify-content-center align-items-center"><div class="card col-4 sharp-corners">
        <div class="card-body m-3">
          ...
          <form method="POST" action="{{ route('register') }}">
              ...
              <div class="form-group mb-4">
                <input type="text" name="username" class="form-control ps-0 @error('username') error-underline @enderror"placeholder="Username">
                @error('username')
              ...
              <div class="form-group mb-4">
                <input type="text" name="email" class="form-control ps-0 @error('email') error-underline @enderrorr @enderror" placeholder="exampleemail@example.com">
                @error('email')
                    <p class="text-danger">{{ $message }}</p>
                @enderror
              </div>
