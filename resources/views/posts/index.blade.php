<x-layout>
    ...
    <div class="container">
        ...
        @auth
            <input type="text" autocomplete="off" class="shadow p-3 form-control border-radius-2-rem mb-5 button-click-animation-sm" id="user-post-input" placeholder="What are you thinking right now?" data-url="{{ route('posts.create') }}">
        @endauth
